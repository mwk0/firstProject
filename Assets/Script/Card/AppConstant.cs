...
namespace Script.Card
{
    ...
    public class AppConstant
    {
        ...
        //预估的结算结果类型
        public const int expectResultType_damage = 0;//伤害
        public const int expectResultType_buff = 1;//buff
        public const int expectResultType_debuff = 2;//debuff
        public const int expectResultType_poison = 3;//毒
