...
namespace Script.Pub.Event
{
    public class EventCenter:SingletonBaseManager<EventCenter>
    {
         private Dictionary<Enum, List<Delegate>> eventDic = new Dictionary<Enum, List<Delegate>>();
    ...
    public void AddListenerBase(Enum eventName, Delegate callback)
    {
    ...
    /// <param name="eventName"></param>
    /// <param name="callback"></param>
    public void AddListener(Enum eventName, Action callback)
    {
    ...
    public void AddListener<T>(Enum eventName, Action<T> callback)
    {
        AddListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    public void AddListener<T1, T2>(Enum eventName, Action<T1, T2> callback)
    {
        AddListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName">事件的名字</param>
    /// <param name="callback">准备用来处理事件 的委托函数</param>
    public void AddListener<T1, T2, T3>(Enum eventName, Action<T1, T2, T3> callback)
    {
        AddListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName">事件的名字</param>
    /// <param name="callback">准备用来处理事件 的委托函数</param>
    public void AddListener<T1, T2, T3, T4>(Enum eventName, Action<T1, T2, T3, T4> callback)
    {
        AddListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName"></param>
    /// <param name="callback"></param>
    public void RemoveListenerBase(Enum eventName, Delegate callback)
    {
    ...
    /// <param name="eventName"></param>
    /// <param name="callback"></param>
    public void RemoveListener(Enum eventName, Action callback)
    {
    ...
    public void RemoveListener<T>(Enum eventName, Action<T> callback)
    {
        RemoveListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName">事件的名字</param>
    /// <param name="callback">对应之前添加的委托函数</param>
    public void RemoveListener<T1, T2>(Enum eventName, Action<T1, T2> callback)
    {
        RemoveListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName">事件的名字</param>
    /// <param name="callback">对应之前添加的委托函数</param>
    public void RemoveListener<T1, T2, T3>(Enum eventName, Action<T1, T2, T3> callback)
    {
        RemoveListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    /// <param name="eventName">事件的名字</param>
    /// <param name="callback">对应之前添加的委托函数</param>
    public void RemoveListener<T1, T2, T3, T4>(Enum eventName, Action<T1, T2, T3, T4> callback)
    {
        RemoveListenerBase(eventName, callback);
    }
    /// <summary>
    ...
    public void TriggerEvent<T>(Enum eventName, T info)
    {
        if (eventDic.ContainsKey(eventName))
        {            
            foreach (Delegate callback in eventDic[eventName])
    ...
    /// </summary>
    /// <param name="eventName">哪一个名字的事件触发了</param>
    public void TriggerEvent<T1, T2>(Enum eventName, T1 info1, T2 info2)
    {
        if (eventDic.ContainsKey(eventName))
        {
            foreach (Delegate callback in eventDic[eventName])
    ...
    /// </summary>
    /// <param name="eventName">哪一个名字的事件触发了</param>
    public void TriggerEvent<T1, T2, T3>(Enum eventName, T1 info1, T2 info2, T3 info3)
    {
        if (eventDic.ContainsKey(eventName))
        {
            foreach (Delegate callback in eventDic[eventName])
    ...
    /// </summary>
    /// <param name="eventName">哪一个名字的事件触发了</param>
    public void TriggerEvent<T1, T2, T3, T4>(Enum eventName, T1 info1, T2 info2, T3 info3, T4 info4)
    {
        if (eventDic.ContainsKey(eventName))
        {
            foreach (Delegate callback in eventDic[eventName])
